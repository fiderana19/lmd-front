        ...
        <div className="px-10">
          <div className="block sm:flex justify-between">
            <div className="text-xl font-bold font-lato">
              LES UNITES D'ENSEIGNEMENTS
            </div>
            <div className="flex justify-end items-center gap-1.5">
              <Input
                className="my-1 mx-1 w-52"
                placeholder="Saisir le nom de l'UE..."
                value={searchUE}
                        ...
                        <td className="px-1 py-4 whitespace-nowrap text-sm leading-5 text-gray-900">
                          <div className="flex justify-center gap-1.5">
                            <Button
                              size={"icon"}
                              onClick={() =>
                                navigate(`/admin/ue/edit/${uee.id_ue}`)
                              }
                            >
                              <EditOutlined />
                            </Button>
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  <AlertDialogTitle>
                                    Suppression d'un unité d'enseignement
                                  </AlertDialogTitle>
                                  <AlertDialogDescription>
