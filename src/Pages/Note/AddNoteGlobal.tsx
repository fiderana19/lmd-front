...
import { CloseCircleFilled, CheckCircleFilled, WarningFilled, LoadingOutlined } from '@ant-design/icons';
      ...
      <div className='mx-auto pb-5 pt-24 sm:px-10 px-5'>
        ...
        <Card>
          <form className='my-7 mx-auto' onSubmit={submit(handleSubmit)}>
            <Label htmlFor='id_etudiant' className='mb-1'>Etudiant : </Label>
            <Controller 
              control={control}
              name='id_etudiant'
              render={({ field: { value, onChange }}) => (
                ...
                >
                  <Option value="">Sélectionnez un etudiant</Option>
                    {
                      etudiant && etudiant.map((et: any, index: any) => {
                        return(
            ...
            <Label htmlFor='valeur' className='mb-1 mt-2'>Note : </Label>
            <Controller 
              control={control}
              name='valeur'
              render={({ field: { value, onChange }}) => (
          ...
          <div className='md:w-1/2 w-full md:py-0 py-4'>
            <div className='flex justify-end'>
              <Input className='my-2 mx-1 w-52' placeholder='Saisir la matricule...' value={searchNote} onChange={(e) => setSearchNote(e.target.value)}  />
            </div>
              <div>
                <table className=' min-w-full divide-y divide-gray-200'>
                    ...
                    <tbody className='bg-white divide-y divide-gray-200'>
                      {
                        (
                        notes?.data && notes?.data.map((note: any, index: any) =>{
