    ...
    <div>
      ...
      <div className='pb-5 pt-24'>
        <div className='lg:px-5 px-1'>
            ...
            <form className='lg:flex block lg:justify-end text-center items-center'  onSubmit={submit(handleSubmit)}>
              <div className='mx-1'>
                <Controller 
                  control={control}
                  name='id_etudiant'
                  render={({ field: { value, onChange } }) => (
                    <Select
                      value={value}
                      onChange={onChange}
                      className={errors?.id_etudiant ? 'border md:w-56 w-full my-1 border-red-500' : 'md:w-56 w-full my-1' }
                      showSearch
