...
const Login: FunctionComponent = () => {
  ...
  const text =
    "LMD, L'APPLICATION DE GESTION DE NOTE UNIVERSITAIRE RESPECTANT LE REGIME LICENCE-MASTER-DOCTORAT";
      ...
      <div className="block sm:justify-between sm:flex h-full">
        ...
        <div className="bg-gray-400 w-1/3 flex flex-col justify-center">
          <form onSubmit={submit(submitLogin)} className="w-60 mx-auto">
            ...
            <Controller
              ...
              render={({ field: { value, onChange } }) => (
                <Input
                  value={value}
                  onChange={onChange}
                  className={`${errors?.username && "border border-red-500 text-red-500 rounded"}`}
                />
              )}
            />
            {errors?.username && (
            ...
            <Label htmlFor="password" className="mb-1 mt-8">
              Mot de passe :
            </Label>
            <Controller
              name="password"
