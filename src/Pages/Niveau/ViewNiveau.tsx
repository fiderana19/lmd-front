...
const ViewNiveau: FunctionComponent = () => {
  ...
  const { mutateAsync: deleteNiveau, isPending: deleteLoading } = useDeleteNiveau({action() {
    refetchNiveau();
  },})
  ...
  return (
    <div>
      ...
      <div className='pb-5 pt-24 bg-gray-100 min-h-screen'>
        {
          niveauLoading && <div className='my-4 mx-auto w-max'>
                            ...
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction className='m-0 p-0'>
                                  <Button 
                                    onClick={() => NiveauDelete(niveau[0].id_niveau)} 
                                    variant={'destructive'}
