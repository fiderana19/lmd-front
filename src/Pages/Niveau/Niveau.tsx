...
import { EditOutlined, DeleteOutlined, LoadingOutlined, PlusOutlined, EyeFilled } from '@ant-design/icons';
...
const Niveau: FunctionComponent = () => {
  ...
  const { mutateAsync: niveauDelete, isPending: deleteLoading } = useDeleteNiveau({action() {
    refecthNiveau()
  },})
                              ...
                              <AlertDialog>
                                  ...
                                  <AlertDialogFooter>
                                      ...
                                      <AlertDialogAction className='m-0 p-0'>
                                        <Button 
                                          onClick={() => handleDelete(niv.id_niveau)} 
                                          variant={'destructive'}
