        ...
        <div className="px-10">
          <div className="block sm:flex justify-between">
            <div className="text-xl font-bold font-lato">
              LES ELEMENTS CONSTUTITIFS
            </div>
            <div className="flex justify-end items-center gap-1.5">
              <Input
                className="w-52"
                placeholder="Saisir le nom de l'EC..."
                value={searchEC}
              ...
              <table className=" min-w-full divide-y divide-gray-200">
                <thead>
                  <tr>
                    ...
                    <th className="lg:px-6 px-2 py-3 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                      Credit
                    </th>
                    <th className="lg:px-6 px-2 py-3 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                      Poids
                    ...
                    ecs.map((element: any, index: any) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className="lg:px-6 px-2 py-4 xl:whitespace-nowrap whitespace-normal text-sm leading-5 text-gray-900 text-center">
                            {" "}
                            {element.credit_ec}{" "}
                          </td>
                          <td className="lg:px-6 px-2 py-4 xl:whitespace-nowrap whitespace-normal text-sm leading-5 text-gray-900 text-center">
                          ...
                          <td className="lg:px-6 px-2 py-4 xl:whitespace-nowrap text-sm leading-5 text-gray-900">
                            {" "}
                            {element.id_ue}{" "}
                          </td>
                          <td className="px-1 py-4 whitespace-nowrap text-sm leading-5 text-gray-900">
                            <div className="flex justify-center gap-1.5">
                              <Button
                                ...
                                variant={"secondary"}
                                onClick={() =>
                                  navigate(`/admin/ec/view/${element.id_ec}`)
                                }
                              >
                                <EyeFilled />
                              </Button>
                              <Button
                                size={"icon"}
                                onClick={() =>
                                  navigate(`/admin/ec/edit/${element.id_ec}`)
                                }
                              >
                                <EditOutlined />
                              </Button>
              ...
              {ecs &&
                ecs.map((element: any, index: any) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="hover:scale-105 duration-300 bg-gray-50"
                    >
                      <div className="text-center">
                        ...
                        <div className="py-3">
                          ...
                          <div className="text-sm flex justify-center">
                            <div className="text-sm underline mr-2">ET :</div>
                            {element.et}
                          </div>
                          <div className="text-sm flex justify-center">
                            <div className="text-sm underline mr-2">ED :</div>
                            {element.ed}
                          </div>
                          <div className="text-sm flex justify-center">
                            <div className="text-sm underline">EP :</div>
                            {element.ep}
                          </div>
                          <div className="text-sm flex justify-center">
                            <div className="text-sm underline mr-2">
