      ...
      <div className="pb-5 pt-24 bg-gray-100 min-h-screen">
        ...
        {ec && (
          <form
            ...
            onSubmit={submit(ECSubmit)}
          >
            <Label htmlFor="nom_ec" className="mb-1">
              Nom de l'element :{" "}
            </Label>
            <Controller
              name="nom_ec"
            ...
            {errors?.id_ec && (
              <div className="text-red-500 text-xs text-left w-full">
                {errors?.id_ec.message}
              </div>
            )}
            {errors?.nom_ec && (
              <div className="text-red-500 text-xs text-left w-full">
                {errors?.nom_ec.message}
              </div>
            )}
            <Label htmlFor="semestre" className="mb-1 mt-4">
              Semestre :{" "}
            </Label>
            <Controller
              name="semestre"
            ...
            <div className="flex justify-between gap-2 mt-4">
              <div>
                <Label htmlFor="et" className="mb-1">
                  ET :{" "}
                </Label>
                <Controller
                  name="et"
              ...
              <div>
                <Label htmlFor="ed" className="mb-1">
                  ED :{" "}
                </Label>
                <Controller
                  name="ed"
              ...
              <div>
                <Label htmlFor="ep" className="mb-1">
                  EP :{" "}
                </Label>
                <Controller
                  name="ep"
            ...
            <div className="flex justify-between gap-2 mt-4">
              <div>
                <Label htmlFor="credit_ec" className="mb-1">
                  Credit de l'element :{" "}
                </Label>
                <Controller
                  name="credit_ec"
                ...
                {errors?.credit_ec && (
                  <div className="text-red-500 text-xs text-left w-full">
                    {errors?.credit_ec.message}
                  </div>
                )}
              </div>
              <div>
                <Label htmlFor="poids_ec" className="mb-1">
                  Poids de l'element :{" "}
                </Label>
                <Controller
                  name="poids_ec"
                ...
                {errors?.poids_ec && (
                  <div className="text-red-500 text-xs text-left w-full">
                    {errors?.poids_ec.message}
                  </div>
                )}
              </div>
            </div>
            <Label htmlFor="id_ue" className="mb-1 mt-4">
              Unité :{" "}
            </Label>
            <Controller
              name="id_ue"
