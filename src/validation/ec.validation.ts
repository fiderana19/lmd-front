...
export const CreateECValidation = yup.object({
    ...
    credit_ec: yup.number().max(60, "Le credit doit être inférieur à 60 !").required("Credit de l'element requis !"), 
    poids_ec: yup.number().max(1, "Le poids ne doit pas depasser 1!").min(0, "Le poids ne doit pas être inferieur à 0").required("Poids de l'element requis !"),
